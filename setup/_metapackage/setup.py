...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-loyalty_criteria_multi_product>=16.0dev,<16.1dev',
        ...
        'odoo-addon-sale_loyalty_auto_refresh>=16.0dev,<16.1dev',
        'odoo-addon-sale_loyalty_criteria_multi_product>=16.0dev,<16.1dev',
        ...
        'odoo-addon-sale_loyalty_multi_gift>=16.0dev,<16.1dev',
